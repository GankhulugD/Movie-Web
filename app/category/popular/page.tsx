...
export default async function PopularPage({
  ...
  const data = await getMoviesByCategory("popular", currentPage);
      ...
      <div className="flex flex-col gap-8 pb-10">
        ...
        <Pagination className="mt-8">
          <PaginationContent>
            ...
            <PaginationItem>
              <PaginationPrevious
                href={`/category/popular?page=${Math.max(1, currentPage - 1)}`}
                className={
            ...
            {pages[0] > 1 && (
              <>
                <PaginationItem>
                  <PaginationLink href="/category/popular?page=1">
                    1
                  </PaginationLink>
                </PaginationItem>
                <PaginationItem>
            ...
            {pages.map((page) => (
              <PaginationItem key={page}>
                <PaginationLink
                  href={`/category/popular?page=${page}`}
            ...
            {pages[pages.length - 1] < totalPages && (
              <>
                ...
                <PaginationItem>
                  <PaginationLink href={`/category/popular?page=${totalPages}`}>
                    {totalPages}
                  </PaginationLink>
                </PaginationItem>
              </>
            ...
            <PaginationItem>
              <PaginationNext
                href={`/category/popular?page=${Math.min(totalPages, currentPage + 1)}`}
                className={
